...
| MAME `src/mame/snk/neogeo.cpp` | `c8f7357b5c573fd7f236c4747f0f34fafe510c54`，2026-08-13、2026-08-14 访问 | MVS/AES 主地址图及 `$000000-$00007F` BIOS/P-ROM vector 切换范围的独立交叉核验 | 文件头 SPDX `BSD-3-Clause`（可与 MIT 共存）；本项目仍只作行为研究，严禁复制代码 |
